...
public class Emailidlogin {
	...
	public static <DesiredCapbilities> void main(String[] args) throws InterruptedException, MalformedURLException {
		...
		System.setProperty("webdriver.gecko.driver", "E:\\\\ChromeTest\\\\chromedriver-win64\\\\chromedriver.exe");
	  ...
	  driver.findElement(By.id("identifierId")).sendKeys("b22019478@gmail.com");
	   ...
	   driver.get("https://dev-admin.cricdost.com/admin/login");
		...
		ele.clear();
		ele.sendKeys("rajeshwarixcel@gmail.com");
		Thread.sleep(2000);

		WebElement ele1 = driver.findElement(By.id("password"));
		ele1.clear();
		ele1.sendKeys("Xcel@123");
		Thread.sleep(2000);
